...
module Api
  class TransactionsController < Api::BaseController
    ...
    def index
      render json: InventoryAuthority.transactions
    end

    def show
      transaction = InventoryAuthority.find_transaction(params[:id])
      if transaction
    ...
    def create
      ...
      transaction = InventoryAuthority.create_transaction!(payload)
    ...
    def refund
      transaction = InventoryAuthority.refund_transaction!(params[:id])
      render json: transaction
    rescue InventoryAuthority::InventoryError => e
